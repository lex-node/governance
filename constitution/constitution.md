...
* **Governance Stake:** POKT deposited with the On-Chain DAO Treasury (or a temporary trust, if the funds have been transferred to the trust by the Foundation). Such a POKT deposit signals  the consent and intention on the part of the despositing holder(s) to participate in the Council. Such a POKT deposit only qualifies as an active Governance Stake if it has completed the Maturation Period and meets the following criteria:
